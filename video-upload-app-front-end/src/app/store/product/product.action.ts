...
// export const getPaginatedProductSuccess = createAction(GET_PAGINATED_SUCCESS, props<{productsDisplay: ProductDisplay[]}>());
...
// export const getFilterProductActionSuccess = createAction(FILTER_LOAD_SUCCESS, props<{productsDisplay: ProductDisplay[]}>());
