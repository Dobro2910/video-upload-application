...
//           tap((response: any) => {
//             console.log(response.productsDisplay);
//           }),
//           map(response => ProductActions.getPaginatedProductSuccess({ productsDisplay: response.productsDisplay })),
//           catchError(error => {
...
//             console.log(response.productsDisplay);
//           }),
//           map(response => ProductActions.getFilterProductActionSuccess({ productsDisplay: response.productsDisplay })),
//           catchError(error => {
//             // Handle login failure, return error message
